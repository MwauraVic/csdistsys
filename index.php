...
<div class="container-xl">
 ...
 <a href="insert.php" class="btn btn-secondary"><i class="materialicons">&#xE147;</i> <span>Add New User</span></a>
...
<!--Fetch the Records -->
 ...
 <td>
 <a href="read.php?viewid=<?php echo htmlentities ($row['ID']);?>" class="view" title="View"
...
title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete?');" ><i class="material-icons">&#xE872;</i></a>
 </td>
 </tr>
 <?php
$cnt=$cnt+1;
